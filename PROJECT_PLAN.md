...
- [x] R7: Keep data portable with browser-local storage and file-based import/export.
...
| F-TS06a | UI foundation: shell layout and German strings | M-TS5 | Done |
...
| H-TS02 | Central event validation write barrier (reject invalid events before persistence/projection) | R1, R3, R5, R7 | Done |
