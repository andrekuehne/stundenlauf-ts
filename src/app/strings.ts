...
export const STR = {
  ...
  views: {
    ...
    history: {
      title: "Historie",
      subtitle: "Ereignisprotokoll fuer den ausgewaehlten Lauf mit Vorschau, Rollback und Hard reset.",
      ...
      actionHardReset: "Hard reset bis hier",
      ...
      hardResetConfirmTitle: "Hard reset bestaetigen?",
      hardResetConfirmBody:
        "Alle Ereignisse nach diesem Punkt werden dauerhaft entfernt. Dieser Schritt ist destruktiv und nicht rueckgaengig.",
